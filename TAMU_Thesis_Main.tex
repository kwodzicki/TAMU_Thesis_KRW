...
% use the \includeChapter command
\includeChapter{./Data/Section1}		% Include the Section1.tex file
\includeChapter{./Data/Section2}		% Include the Section2.tex file
\includeChapter{./Data/Section3}		% Include the Section3.tex file
\includeChapter{./Data/Section4}		% Include the Section4.tex file
