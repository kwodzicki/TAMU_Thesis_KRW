...
## Major features
* Places all formating in the tamu\_thesis class for better end-user experience
...
## Using the Template
Unless you are familiary with the LaTeX document preparation system, I highly recommend reading through the TAMU\_Thesis\_Main.pdf document before using the template.
After you have read through
the document, I suggest going through the TAMU\_Thesis\_Main.tex document, and all the other `.tex` documents in the Data/ directory, one at a time to compare the LaTeX code to the PDF output.
...
In most cases you will only need to download the updated tamu\_thesis.cls file.
However, it is a good idea to check the change\_log.txt to see what files are required for update.
